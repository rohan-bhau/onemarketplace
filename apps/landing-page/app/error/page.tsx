...
const errorMessages: Record<string, string> = {
    ...
    authentication_unavailable: "Authentication is currently unavailable. Please try again later.",
    role_mismatched: "The role you selected does not match your account. Please try again.",
    invalid_or_expired_token: "Your signup token is invalid or has expired. Please try again.",
    backend_signup_failed: "We couldn't create your account. Please try again later.",
}
...
const Page = async ({ searchParams }: ErrorPageProps) => {
  ...
  const message = errorMessages[reason ?? ""] ?? "Something went wrong. Please try again.";
